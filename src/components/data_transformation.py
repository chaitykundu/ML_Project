...
import numpy as np
import pandas as pd
#column transformer used for pipelining
from sklearn.compose import ColumnTransformer  
from sklearn.impute import SimpleImputer #checking missing values
...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        try:
            ...
            logging.info("Nummerical column standard scaling completed")
